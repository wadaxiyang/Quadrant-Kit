...
Current navigation Phase 3 implementation, API review, native evidence and check
results are recorded in [NAVIGATION_REBUILD_PHASE3.md](NAVIGATION_REBUILD_PHASE3.md).
