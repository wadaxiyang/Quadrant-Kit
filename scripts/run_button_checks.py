...
def main(argv=None):
    ...
    if args.suite == 'gallery-settings':
        stem, executable_name = 'gallery_settings_check', 'gallery-settings-check'
    ...
    fixture = (ROOT / ('scripts/' + stem + '.slint')).read_text(encoding='utf-8')
    fixture = fixture.replace('__GALLERY_SETTINGS__', (ROOT/'gallery/ui/pages/settings_page.slint').as_posix())
    fixture = fixture.replace('__GALLERY_TOOLBAR__', (ROOT/'gallery/ui/shared/gallery_toolbar.slint').as_posix())
    generate(project, fixture, executable_name, True)
